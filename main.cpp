...
vec3 light_source_color(const ray &r, object *world, int depth)
{
    hit_record rec;
...
int main(int argc, char *argv[])
{
    ...
    object *world = cornell_box();
    // object *world = sun_scene();
    ...
    start_t = std::clock();
    std::cout << "Rendering starts, please wait" << std::endl;
